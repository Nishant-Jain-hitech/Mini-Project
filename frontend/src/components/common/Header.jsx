        ...
        <div className="flex items-center gap-2 md:gap-6">
          ...
          {isAuthenticated ? (
            <div className="hidden sm:flex items-center gap-4 pl-4 border-l border-white/10">
              ...
              >
                <div className="w-8 h-8 rounded-full bg-blue-600/20 border border-blue-500/50 flex items-center justify-center group-hover:border-blue-400 transition-colors">
