      ...
      <div className="max-w-7xl mx-auto pt-12 pb-8 px-6 lg:px-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="col-span-1">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              The ultimate destination for cricket fans. Stream exclusive web
              series, interact with the pavilion, and stay updated with the live
              match pulse.
            </p>
          </div>
          ...
          {/* Platform Section */}
          <div>
            <h3 className="text-white font-bold mb-4 text-sm uppercase tracking-widest opacity-70">
              Platform
            </h3>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-[11px] text-slate-500 font-medium text-center md:text-left">
            © 2026 CricSocial. No affiliation with ICC or BCCI. All rights
            reserved.
          </p>
