      ...
      >
        ...
        <div className="px-6 py-4 flex-1 overflow-y-auto no-scrollbar">
                  ...
                  {allMatchData[selectedCategory].map((match) => (
                    ...
                    >
                      <div className="flex justify-between items-start mb-1">
                        <p className="text-xs font-bold text-white group-hover:text-blue-400 uppercase">
                          {match.teams}
                        </p>
                        <span className="flex h-2 w-2 rounded-full bg-red-600 animate-pulse" />
                      </div>
                      <p className="text-[9px] text-slate-500 font-medium">
                        {match.fans} fans in the booth
                      </p>
                    </button>
                  ))}
                </div>
          ...
          <div className="mt-8 p-4 rounded-xl bg-gradient-to-br from-blue-600/20 to-transparent border border-blue-500/20">
            <p className="text-[10px] font-bold text-blue-400 mb-2 font-mono italic tracking-tighter">
              #FANPOLL_LIVE
            </p>
            <p className="text-xs text-white font-bold leading-tight mb-4">
            ...
            <div className="space-y-3">
              <div className="space-y-1">
                <div className="flex justify-between text-[10px] font-bold mb-1">
                  ...
                  <span
                    className={hasVoted ? "text-blue-400" : "text-slate-500"}
                  >
                    {votes.ind}%
                  </span>
                </div>
