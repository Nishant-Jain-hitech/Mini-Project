  ...
  const mockActivity = [
    {
      id: 1,
      action: "Won Match",
      target: "vs Thunderbirds",
      xp: "+450 XP",
      time: "2h ago",
    },
    {
      id: 2,
      action: "Unlocked Card",
      target: "Ben Stokes",
      xp: "Rare Drop",
      time: "5h ago",
    },
        ...
        <div className="relative bg-gradient-to-br from-blue-600 to-blue-900 rounded-[3rem] p-8 md:p-16 overflow-hidden shadow-2xl shadow-blue-500/10">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
            ...
            >
              {image ? (
                ...
                <div className="text-white/20 flex flex-col items-center">
                  <span className="text-6xl font-black mb-1 uppercase">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-blue-100 font-bold uppercase tracking-widest text-sm mb-6">
                Level {user?.username?.length || 1} Cricket Strategist
              </p>
              <div className="px-4 py-2 bg-white/10 backdrop-blur-md rounded-xl border border-white/20 inline-block">
                <p className="text-[10px] text-blue-100 font-black uppercase opacity-60">
                  Identity
                </p>
              ...
              {activeTab === "My Collection" && (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                  {mockCollection.map((item) => (
                    <div
                      key={item.id}
                      className="bg-white/5 border border-white/10 p-6 rounded-[2rem] hover:border-blue-500/50 transition-colors group"
                    >
              ...
              {activeTab === "Activity" && (
                <div className="space-y-4">
                  {mockActivity.map((act) => (
                    <div
                      key={act.id}
                      className="flex items-center justify-between p-6 bg-white/5 border border-white/5 rounded-2xl hover:bg-white/[0.07] transition-colors"
                    >
