  ...
  const media = [
    {
      ...
      rating: "8.5",
      year: "2016",
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSeUtKl0XWIsxOliIYaH5xZHG4Drtz37EZIs16TmOTQv7ppBYoOIh6_c7opQhHCVS_wpwC4uQXg2mS1Tp98RAs1oGX1B6hl2KzfdA0oR_PI4Q&s=10",
    ...
    },
    {
      ...
      rating: "8.2",
      year: "2022",
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSYSUGI0esxMo7ab84MblFgV2-lnCkxDquRZ6-2xl8_hEFbnNTcI7nWVx_65dXvAIIKIzhe4_gNo9HGwd5TZlgDNEAF_omXmg-lOXEpOVd5&s=10",
    ...
    },
    {
      ...
      rating: "8.9",
      year: "2020",
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQy-KHD_-C2Cnk_Ual23wRpvysaw57oDeFUveO4f9z-f9iZx38ZJyQLQimcX70qCfEmk97AXoeXdHPn4vySKimJpnE2PSZvjpLa1-yWwPVu&s=10",
        ...
        <div className="absolute bottom-20 left-4 md:left-12 z-20 max-w-3xl">
          ...
          >
            ...
            <p className="text-slate-300 text-lg md:text-xl max-w-xl font-medium leading-relaxed mb-4">
              Experience the cinematic journey of Kapil's Devils as they conquered the world against all odds at Lord's.
            </p>
            ...
            >
              ...
              <div className="mt-6 px-2">
                ...
                <div className="flex items-center gap-3 mt-2.5">
                  <span className="text-[10px] text-slate-500 font-black uppercase tracking-widest">{item.year}</span>
                  <span className="w-1 h-1 rounded-full bg-slate-800" />
                  <span className="text-[10px] text-blue-500 font-black uppercase tracking-widest">{item.type}</span>
                </div>
              </div>
            </motion.div>
          ))}
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-b from-transparent via-transparent to-black/90">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-blue-500/30 font-black uppercase tracking-[0.8em] text-[10px]">CricSocial Premium Streaming</p>
                </div>
              </div>
                ...
                <div className="mb-8 flex justify-between items-end">
                  <div>
                    <div className="flex gap-3 mb-3">
                       <span className="text-blue-500 text-[9px] font-black uppercase tracking-[0.2em] bg-blue-500/10 px-3 py-1 rounded-lg border border-blue-500/20">{selectedVideo.type}</span>
                       <span className="text-slate-500 text-[9px] font-black uppercase tracking-[0.2em] bg-white/5 px-3 py-1 rounded-lg border border-white/5">{selectedVideo.year}</span>
                    </div>
                    <h3 className="text-white font-black uppercase tracking-tighter text-3xl md:text-5xl italic leading-none">{selectedVideo.title}</h3>
                  </div>
                ...
                <div className="flex flex-col gap-8">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-8">
                       <span className="text-[9px] text-blue-500 font-black px-3 py-1 bg-blue-500/10 border border-blue-500/20 rounded-md tracking-widest uppercase">4K Ultra HD</span>
                       <button className="text-white hover:text-blue-500 transition-all"><Maximize className="w-6 h-6" /></button>
                    </div>
                  </div>
                </div>
              </div>
