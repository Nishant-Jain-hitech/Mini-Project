        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <p className="max-w-2xl mx-auto text-slate-400 text-lg lg:text-xl font-medium mb-10">
              Experience cricket like never before. Real-time scores, fan pavilions, and a community that never stops cheering.
            </p>
          ...
          >
            {[
              { icon: <Trophy />, title: "Live Action", desc: "Ball-by-ball updates and deep stats." },
              { icon: <Users />, title: "Fan Pavilion", desc: "Connect with fans across the globe." },
              { icon: <Tv />, title: "Entertainment", desc: "Movies, series, and exclusive content." }
            ].map((feature, i) => (
              <div key={i} className="p-8 rounded-3xl bg-white/5 border border-white/5 backdrop-blur-sm">
                ...
                <h3 className="font-black uppercase tracking-widest mb-2">{feature.title}</h3>
