    ...
    <div className="min-h-screen bg-slate-950 py-20 px-6 md:px-20">
      <header className="max-w-4xl mb-20">
        ...
        <p className="text-slate-400 text-lg leading-relaxed max-w-2xl">
          CricSocial was born in the stands. We felt the static nature of sports
          apps didn't capture the electricity of a last-over thriller. We built
          a digital stadium where data meets discussion, and every boundary
          feels personal.
        </p>
      </header>
        ...
        <div className="space-y-8">
          <div className="space-y-2">
            ...
            <p className="text-slate-400">
              To create the world's most immersive cricket ecosystem, bridging
              the gap between raw data and fan emotion.
            </p>
          </div>
          <div className="space-y-2">
            <h2 className="text-3xl font-black text-white uppercase">
            ...
            <p className="text-slate-400">
              Powered by real-time low-latency streams and a community-first
              architecture, ensuring you're always in the crease.
            </p>
          </div>
        </div>
